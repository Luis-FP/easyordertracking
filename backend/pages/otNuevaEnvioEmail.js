...
@media screen and (max-width:400px) {
    ...
    .col-6{width:100%;flex:inherit;max-width:90%}
     ...
     <h1 class="col-12 text-center">Nuevo lote de OTs abiertas</h1><br>
     <h2 class="col-12 text-center">Se han creado nuevas OT</h2><br>
     ...
     <div class="row justify-content-center"> 
     <a href="https://laprensa.com" class="col-6 mx-auto"> 
