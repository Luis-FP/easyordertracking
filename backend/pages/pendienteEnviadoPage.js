 ...
 const pendienteNotificacionEmail = (titulo) => {
     let html = 
     `<!DOCTYPE html>
     <html> 
     <head>
...
@media screen and (max-width:400px) {
    ...
    .col-6{width:100%;flex:inherit;max-width:90%}
     ...
     <h1 class="col-12 text-center">Usted ha recibido un <br><b>Nuevo Pendiente: </b>${titulo}</h1>
     <h3 class="col-12 text-center">Por favor revisarlo en el app</h3>
     </div> 
     </div>
     <div class="row justify-content-center"> 
     <a href="https://homeof-app.herokuapp.com/revisionquejas" class="col-6 mx-auto"> 
...
export {pendienteNotificacionEmail};