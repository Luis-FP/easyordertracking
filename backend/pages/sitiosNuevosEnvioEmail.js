 ...
 const sitiosNuevosEmail = (info) => {
   //   console.log('info', info)
     ...
     <div class="row justify-content-center">
        ...
        <h1 class="col-12 text-center">Se han Creado Sitios Nuevos</h1>
        
        </div> 
    </div> 
     <div class="col-12 mx-auto">
        <p class="col-12 text-center">Usuario:${info.nombre} </p>
        <p class="col-12 text-center">Cliente:${info.empresa} </p>
     </div>
   
     </div>
     <div class="row justify-content-center"> 
     <a href="https://easyordertracking.herokuapp.com" class="col-6 mx-auto"> 
