...
import { crearSitios } from "../actions/userActions";
...
function CrearOTScreen(props) {
  ...
  const { loading, createSitio, error } = useSelector((state) => state.createSitioR)
  ...
  return (
    <div className="w3-row w3-center  w3-margin-bottom">
      <h1 className="w3-xxlarge w3-text-dark-grey">Subir Datos de Sitios</h1>
